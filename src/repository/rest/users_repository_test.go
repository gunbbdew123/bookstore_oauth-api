...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"id": "1", "first_name": "Saku", "last_name": "Hana", "email": "dewbbgun@hotmail.com"}`,
	})
...
func TestLoginUserNoError(t *testing.T) {
	...
	assert.EqualValues(t, "Saku", user.FirstName)
	assert.EqualValues(t, "Hana", user.LastName)
	assert.EqualValues(t, "dewbbgun@hotmail.com", user.Email)
}
